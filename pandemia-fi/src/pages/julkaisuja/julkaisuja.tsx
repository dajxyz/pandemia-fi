        ...
        <Box width={[1]} sx={{ p: 0 }}>
          <Card sx={{ p: 0, maxWidth: "100%" }}>
            ...
            <p>
              ...
              käytetään myös termejä HCov-19 ja SARS-2; kyseisen viruksen
              aiheuttama sairaus, COVID-19; kyseisen viruksen leviämisen ehkäisy
              sekä sairauden hoito. Listan artikkelit on valikoitu yli 600
              artikkelin joukosta journaalin vaikuttavuuskertoimen, artikkelin
              viittausmäärän ja mediaseurannan perusteella.
            </p>
            <p>
              Verkossa on useita kokoelmia tutkimusta, mutta tämä on
              tietääksemme ainoa kuratoitu sellainen. Paras lähde kaiken aiheen
              tutkimuksen seurantaan on vasta-avattu{" "}
              ...
              <a href="https://www.ncbi.nlm.nih.gov/pubmed/">PubMed</a>:istä).
              Suodattamattomia tietokantoja akateemisesta tutkimuksesta löytyy
              mm.{" "}
              <a href="https://www.who.int/emergencies/diseases/novel-coronavirus-2019/global-research-on-novel-coronavirus-2019-ncov">
                WHO
              </a>
              :n,{" "}
              <a href="https://www.microsoft.com/en-us/research/project/academic/articles/microsoft-academic-resources-and-their-application-to-covid-19-research/">
